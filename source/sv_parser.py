...
def read_pandas(filepath):
    ...
    df = pd.read_table("../data/" + filepath)
    return df
...
if __name__ == "__main__":
    try:
        ...
        pd = read_pandas('EEE_SV-Pop_1.ALL.sites.20181204.annotated.tsv')
        parse_pandas(pd, data, 'EEE_SV-Pop_1.ALL.sites.20181204.annotated.tsv')
